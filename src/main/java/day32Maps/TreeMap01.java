...
public class TreeMap01 {
    public static void main(String[] args) {
        /*
            1)tree kelimesini duyunca aklınıza naturel order gelmelidir
            2)treeMapler entrysetleri keylere göre naturel ordere göre sıralar
            3)TreeMapler en yavaş maplerdir
            4)treeMapler threatSafe ve senkronize değildir
         */
